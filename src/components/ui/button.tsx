  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Executive primary - bold and confident
        executive: "bg-foreground text-background hover:bg-foreground/90 rounded-full font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0",
        // Executive secondary - subtle and refined
        executiveOutline: "bg-transparent text-foreground border-2 border-foreground/15 hover:border-foreground/30 hover:bg-secondary rounded-full font-semibold",
        // Accent button for success states
